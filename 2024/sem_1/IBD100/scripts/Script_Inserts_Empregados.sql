	--------------------------------------------------------
	--  Arquivo criado - Terça-feira-Agosto-23-2022   
	--------------------------------------------------------
	REM INSERTING into ALUNO_01.EMP
	SET DEFINE OFF;
	Insert into EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('1','JOSÉ','ANALISTA','1',to_date('10/10/22','DD/MM/RR'),'2500','2','10');
	...
	Insert into EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('90','JOÃO','TECNICO','1',to_date('01/01/22','DD/MM/RR'),'900','2','20');
	...
	Insert into EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('110','TIÃO','Vendedor','2',to_date('11/02/22','DD/MM/RR'),'1000','2','20');
